    ...
    <motion.div
      ...
      exit={{
        ...
        transition: {
          duration: 0.75,
          ease: "easeInOut",
          delay: 0.1, // Gives the jet a head start on its take-off flight path
        },
      }}
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[oklch(0.985_0.012_80)] select-none overflow-hidden"
    >
      ...
      {/* 1. Jet Icon (Supersonic take-off flight path upward) */}
      <motion.div
        ...
        exit={{
          ...
          transition: {
            duration: 0.95,
            ease: [0.6, -0.28, 0.735, 0.045], // Custom jet ignition take-off curve (dip then rocket)
          },
        }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        className="mb-8 text-coral z-20"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      {/* 2. Text Details (Counter + line + subtitle fade/slide down) */}
      <motion.div
